          ...
          <div class="box">
			...
			foreach($templates as $key => $val){  ?>
                <tr>
                  ...
                  <td align="center">
				  <a href="<?php echo URL::to('/admin/edit_template', ['id'=>base64_encode($val->id)]) ?>"><i class="fa fa-fw fa-pencil fa-2x"></i></a>
                  <a href="<?php echo URL::to('/admin/delete_template', ['id'=>base64_encode($val->id)]) ?>"><i class="fa fa-bitbucket fa-2x"></i></a>
                  </td>
                </tr>
                <?php  }  ?>
